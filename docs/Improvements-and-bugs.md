...
1. When audio is playing I'd like you to highlight the Ayah being recited even in the "Read" page. We need to better integrate the "Read" and "Listen capabilities, you're thinking of them too much as two separate use cases, we should actually merge them into a single page called "Quran". Where you select the Quran
